...
export const ARABIC_PROGRAM_COURSES_EN: QuranCourse[] = [
  {
    ...
    images: [arabicImg("نور البيان.png"), arabicImg("نور البيان 2.png")],
  ...
  },
  {
    ...
    images: [arabicImg("ChatGPT Image Jul 25, 2026, 03_03_08 PM.png")],
    bottomImage: arabicImg("لغة عربية عام -.png"),
    bottomImageSection: "teacher",
    accent: "#2156A0",
  },
  {
    ...
    images: [arabicImg("Quranic Arabic.png"), arabicImg("ChatGPT Image Jul 25, 2026, 03_29_28 PM.png")],
    bottomImage: arabicImg("ChatGPT Image Jul 25, 2026, 03_35_30 PM.png"),
    bottomImageSection: "teacher",
    accent: "#1D6B4A",
  },
  {
    ...
    images: [arabicImg("ChatGPT Image Jul 25, 2026, 03_46_57 PM.png")],
    bottomImage: arabicImg("مؤهلات 2-طرق تدريس قسم اللغة العربية.jpeg"),
    bottomImageSection: "teacher",
    accent: "#C05621",
  },
  {
    ...
    images: [arabicImg("ChatGPT Image Jul 25, 2026, 04_03_20 PM.png"),
      arabicImg("Classical Arabic.jpeg")],
    bottomImage: arabicImg("مؤهلات مدرسين.png"),
    bottomImageSection: "teacher",
    accent: "#6B46C1",
  },
  {
    ...
    images: [arabicImg("ChatGPT Image Jul 25, 2026, 04_14_41 PM.png")],
    bottomImage: arabicImg("العربية ( Modern standard.png"),
    accent: "#334155",
  },
];

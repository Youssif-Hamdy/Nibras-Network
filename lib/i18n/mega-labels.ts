...
export const megaLinkAr: Record<string, string> = {
  ...
  "/courses/kids-programs": "برامج الأطفال",
  "/courses/kids-programs#by-age": "حسب العمر",
  "/courses/kids-programs#quran": "تعلّم القرآن",
  "/courses/kids-programs#arabic": "اللغة العربية",
  "/courses/kids-programs#islamic": "الدراسات الإسلامية",
  "/courses/kids-programs#goals": "أهداف التعلّم",
  "/courses/kids-programs#parent": "منطقة أولياء الأمور",
  ...
  "/courses/new-muslims-track": "مسار المسلم الجديد",
  "/courses/family-packages": "باقات عائلية (وفر 20–30٪)",
  "/courses/special-needs-support": "دعم ذوي الاحتياجات الخاصة",
  "/courses/intensive-programs": "البرامج المكثّفة",
  "/courses/exam-preparation": "التحضير للاختبارات والشهادات",
  "/courses/parent-guided-programs": "البرامج بإرشاد الوالدين",
  "/courses/ijazah-pathway": "مسار الإجازة",
  "/courses/teacher-certification": "شهادة تأهيل المعلّمين",
  "/courses/corporate-training": "التدريب المؤسسي",
};

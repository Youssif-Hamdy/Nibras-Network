...
> = {
  BookOpen: {
    ...
    chip:       "bg-[#eaf4ed] border-[#1C3A2E] text-[#0e2a1e]",
  },
  PenLine: {
    tab:        "text-[#1c7a45] border-[#1c7a45]",
    tabActive:  "text-[#1c7a45] border-b-[3px] border-[#1c7a45]",
    pill:       "border-[#1c7a45] text-[#1c7a45]",
    pillActive: "bg-[#1c7a45] text-white border-[#1c7a45]",
    chip:       "bg-[#fdf8eb] border-[#1c7a45] text-[#0f4024]",
  },
  Landmark: {
    tab:        "text-[#0f5132] border-[#0f5132]",
    tabActive:  "text-[#0f5132] border-b-[3px] border-[#0f5132]",
    pill:       "border-[#0f5132] text-[#0f5132]",
    pillActive: "bg-[#0f5132] text-white border-[#0f5132]",
    chip:       "bg-[#e6f0e9] border-[#0f5132] text-[#072a19]",
  },
  Baby: {
    tab:        "text-[#2E5042] border-[#2E5042]",
    tabActive:  "text-[#2E5042] border-b-[3px] border-[#2E5042]",
    pill:       "border-[#2E5042] text-[#2E5042]",
    pillActive: "bg-[#2E5042] text-white border-[#2E5042]",
    chip:       "bg-[#fbf4e6] border-[#2E5042] text-[#162720]",
  },
  Briefcase: {
    tab:        "text-[#23493A] border-[#23493A]",
    tabActive:  "text-[#23493A] border-b-[3px] border-[#23493A]",
    pill:       "border-[#23493A] text-[#23493A]",
    pillActive: "bg-[#23493A] text-white border-[#23493A]",
    chip:       "bg-[#e1efe6] border-[#23493A] text-[#10241c]",
  },
};
